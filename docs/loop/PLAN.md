...
| M8-06 | **前端重构（补 S7）**：拆分 ChatView/AutomationView 等大 View；删 PlaceholderView 死代码；naive-ui 按需引入 + manualChunks | ✅ | 首屏 <500KB gzip（实测 320.4KB，较基线 456.9KB 降 29.9%）；vue-tsc 绿；功能不回归 | M0-17 |
